...
Public Class Section5
    ...
    Private Sub btnNextS5_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnNextSec5_Click(sender As Object, e As EventArgs) Handles btnNextSec5.Click
        ...
        'nSelectedIndex = cboA1S5.SelectedValue.ToString


        'Main.writer.WriteLine("Section 5")
        'Main.writer.WriteLine("Category: " & nSelectedIndex)
        'Main.writer.WriteLine("Additional Comments: None")
        'Main.writer.Close()

    End Sub

    Private Sub Section5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
