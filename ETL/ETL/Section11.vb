Public Class Section11
    ...
    Private Sub btnNextS11_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnNextSec11_Click(sender As Object, e As EventArgs) Handles btnNextSec11.Click
        Dim x As Integer = 12
        Dim y As Integer = 12
        Dim forms As Form() = {Section12, Section13, Section14, Section15, Section16, Section17, Section18, Section19, Section20, Section21, Section22, Section23, Section24, Section25, Section26}
        Dim Section As Form
        Dim chk As CheckBox
        Dim Checkboxes As CheckBox() = {Main2.mainInst.chkSec12, Main2.mainInst.chkSec13, Main2.mainInst.chkSec13, Main2.mainInst.chkSec14, Main2.mainInst.chkSec15, Main2.mainInst.chkSec16, Main2.mainInst.chkSec17, Main2.mainInst.chkSec18, Main2.mainInst.chkSec19, Main2.mainInst.chkSec20, Main2.mainInst.chkSec21, Main2.mainInst.chkSec22, Main2.mainInst.chkSec23, Main2.mainInst.chkSec24, Main2.mainInst.chkSec25, Main2.mainInst.chkSec26}
    ...
    Private Sub Section11_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub txtSection9_TextChanged(sender As Object, e As EventArgs) Handles txtSection9.TextChanged
