Public Class Section16
    ...
    Private Sub btnNextS16_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnNextSec16_Click(sender As Object, e As EventArgs) Handles btnNextSec16.Click
        Dim x As Integer = 17
        Dim y As Integer = 17
        Dim forms As Form() = {Section17, Section18, Section19, Section20, Section21, Section22, Section23, Section24, Section25, Section26}
        Dim Section As Form
        Dim chk As CheckBox
        Dim Checkboxes As CheckBox() = {Main2.mainInst.chkSec17, Main2.mainInst.chkSec18, Main2.mainInst.chkSec19, Main2.mainInst.chkSec20, Main2.mainInst.chkSec21, Main2.mainInst.chkSec22, Main2.mainInst.chkSec23, Main2.mainInst.chkSec24, Main2.mainInst.chkSec25, Main2.mainInst.chkSec26}
    ...
    Private Sub Section16_Load(sender As Object, e As EventArgs) Handles MyBase.Load
